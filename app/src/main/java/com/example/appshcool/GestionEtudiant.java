...
import com.example.appshcool.CourseDetailsProf;
...
import de.hdodenhof.circleimageview.CircleImageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewCoursesBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(com.example.appshcool.GestionEtudiant.this, CourseDetailsEtudiant.class);
                startActivity(i);
            }
        });
            ...
            ref.putFile(filePath)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(com.example.appshcool.GestionEtudiant.this, "Uploaded", Toast.LENGTH_SHORT).show();
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressDialog.dismiss();
                            Toast.makeText(com.example.appshcool.GestionEtudiant.this, "Failed "+e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
    ...
    private void addDataToFirestore(String courseName, String courseDescription, String courseDuration) {
        ...
        CollectionReference dbCourses = db.collection("Etudiant");
        ...
        dbCourses.add(courses).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
            ...
            public void onSuccess(DocumentReference documentReference) {
                ...
                Toast.makeText(com.example.appshcool.GestionEtudiant.this, "Your information has been added to Firebase Firestore", Toast.LENGTH_SHORT).show();
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(com.example.appshcool.GestionEtudiant.this, "Fail to add information \n" + e, Toast.LENGTH_SHORT).show();
            }
        });
    }
}
