...
import com.example.appshcool.updateCourseProf;
...
public class CourseRVAdapterEtudiant extends RecyclerView.Adapter<com.example.appshcool.CourseRVAdapterEtudiant.ViewHolder> {
    ...
    public CourseRVAdapterEtudiant(ArrayList<CouresEtudiant> coursesArrayList, Context context) {
    ...
    @NonNull
    @Override
    public com.example.appshcool.CourseRVAdapterEtudiant.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // passing our layout file for displaying our card item
        return new com.example.appshcool.CourseRVAdapterEtudiant.ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_coursetudiant, parent, false));
    }



    @Override
    public void onBindViewHolder(@NonNull com.example.appshcool.CourseRVAdapterEtudiant.ViewHolder holder, int position) {

        CouresEtudiant courses = coursesArrayList.get(position);
...
// for our item of recycler view.
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    CouresEtudiant courses = coursesArrayList.get(getAdapterPosition());

                    // below line is creating a new intent.
                    Intent i = new Intent(context, updateCourseEtudiant.class);
