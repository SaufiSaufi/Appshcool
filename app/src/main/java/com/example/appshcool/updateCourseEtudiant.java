...
public class updateCourseEtudiant extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_course_etudiant);
        CouresEtudiant courses = (CouresEtudiant) getIntent().getSerializableExtra("course");
    ...
    private void deleteCourse(CouresEtudiant courses) {
                ...
                // method to delete this data.
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(updateCourseEtudiant.this, "Prof has been deleted from Database.", Toast.LENGTH_SHORT).show();
                            Intent i = new Intent(updateCourseEtudiant.this, GestionEtudiant.class);
                            startActivity(i);
                        } else {
                            // if the delete operation is failed
                            // we are displaying a toast message.
                            Toast.makeText(updateCourseEtudiant.this, "Fail to delete the prof. ", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }

    private void updateCourses(CouresEtudiant courses, String courseName, String courseDescription, String courseDuration) {
        ...
        CouresEtudiant updatedCourse = new CouresEtudiant(courseName, courseDescription, courseDuration);
        ...
        db.collection("Etudiant").
                ...
                // calling a method for on success listener.
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(updateCourseEtudiant.this, "Prof has been updated..", Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(updateCourseEtudiant.this, "Fail to update the data..", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
