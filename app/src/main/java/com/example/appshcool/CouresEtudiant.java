...
public class CouresEtudiant  implements Serializable {
    ...
    public CouresEtudiant  () {
        // empty constructor required for Firebase.
    }

    // Constructor for all variables.

    public CouresEtudiant  (String courseName, String courseDescription, String courseDuration ) {
